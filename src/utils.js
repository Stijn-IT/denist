...
const getBirtday = function (min, max) {
...
const generatePatient = () => {
  ...
  return {
    ...
    ...{
      ...
      birthYear: getBirtday(1931, 2015).toFixed(0),
    },
  };
};
...
const generateRandomAppointmentss = () => {
  const appointmentt = generateRandomAppointment();
  const idd = appointmentt.patient.id
  return {
    ...appointmentt,
    ...{
      id: idd,
...
const generateRandomAppointments = num =>
  Array(num)
    .fill(0)
    .map(_ => generateRandomAppointmentss());
